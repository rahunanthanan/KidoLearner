                                          ...
                                          <table class="table table-bordered" id="table_ID">
                                                     <thead>
                                                                  <tr>
                                                                              ...
                                                                              <th class="col-sm-2">ATTEMPT QUIZ</th>
                                                     ...
                                                     <tbody>
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      @foreach($quizpaper as $quiz)
                                                                                  ...
                                                                                  <td class="col-sm-2"> <input type="text"  class="form-control" name="quiz" value={{$quiz->quizID}}></td>

                                                                                  <td class="col-sm-2"><button id="view" class="btn btn-warning" type="button" name="btn" data-toggle="modal" data-target="#view{{$quiz->quizID}}" class="btn btn-info">ATTEMPT QUIZ</button></td>
