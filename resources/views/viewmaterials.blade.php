                             ...
                             <tbody>
                                          ...
                                          <tr>
                                              ...
                                              @foreach($materials as $material)
                                                          ...
                                                          <td class="col-sm-2">{{$material->id}}</td>
                                                          <td class="col-sm-2">{{$material->category}}</td>
                                                          <td class="col-sm-2">{{$material->type}}</td>

                                                          <td class="col-sm-2">{{$material->name}}</td>
                                                          <td class="col-sm-2">{{$material->author}}</td>
                                                          <td class="col-sm-2">{{$material->date}}</td>
                                                          <td class="col-sm-2">{{$material->pb}}</td>
                                                          <td class="col-sm-2">{{$material->original_filename}}</td>
                                                          <td class="col-sm-2">{{$material->description}}</td>
