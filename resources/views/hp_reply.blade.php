                             ...
                             <thead>
                                          <tr>
                                                      ...
                                                      <th class="col-sm-2">Complaint</th>
                                                       ...
                                                       <th class="col-sm-2">Reply</th>
                                                      <th class="col-sm-2">Add Reply</th>
                                ...
                                <div class="modal-dialog"  style="width: 40%" >
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title custom_align" id="Heading"><strong><font color="green">Send Reply</font></strong></h4>
                                        </div>
                                        <div class="modal-body">

                                            <fieldset>

                                                {!! Form::open(array('url'=>'hp_reply')) !!}
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">ID</label>
                                                    <div class="col-sm-6">
                                                        <input type="text"  name="id" id="TextInput" class="form-control" value="{{$help->HID}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text"  name="reply" id="TextInput" class="form-control" value="{{$help->reply}}">
                             ...
                             <tbody>
                                          ...
                                          <tr>
                                              ...
                                              @foreach($doubts as $doubt)
                                                          ...
                                                          <td class="col-sm-2">{{$doubt->reply}}</td>
                                            <script>
                                                     var cell = $('td');
                            ...
                            <div id="viewTable5" class="modal fade" role="dialog">
                                <div class="modal-dialog"  style="width: 40%" >
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">ID</label>
                                                    <div class="col-sm-6">
                                                        <input type="text"  name="id" id="TextInput" class="form-control" value="{{$doubt->HID}}">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Reply</label>
                                                    <div class="col-sm-6">
                                                        <input type="text"  name="reply" id="TextInput" class="form-control" value="{{$doubt->reply}}">
                                        ...
                                        <div class="modal-footer">
                                            <input class="btn btn-primary" name="btn" value="SendReply" type="submit">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            ...
                            <div id="viewTable6" class="modal fade" role="dialog">
                                <div class="modal-dialog"  style="width: 40%" >
                                    ...
                                    <div class="modal-content">
                                            ...
                                            <fieldset>
                                                ...
                                                {!! Form::open(array('url'=>'hp_reply')) !!}
                                                 <div class="form-group">
                                                    <label class="col-sm-4 control-label">ID</label>
                                                    <div class="col-sm-6">
                                                        <input type="text"  name="id" id="TextInput" class="form-control" value="{{$re->HID}}">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Reply</label>
                                                    <div class="col-sm-6">
                                                        <input type="text"  name="reply" id="TextInput" class="form-control" value="{{$re->reply}}">
                                        ...
                                        <div class="modal-footer">
                                             <input class="btn btn-primary" name="btn" value="Send" type="submit">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
